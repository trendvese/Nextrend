        ...
        <div className="bg-gray-900/50 rounded-2xl border border-white/10 p-8 md:p-12">
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-gray-300">
            ...
            <section>
              ...
              <p>
                Welcome to TrendVerse ("we," "our," or "us"). We are committed to protecting your personal 
                information and your right to privacy. This Privacy Policy explains how we collect, use, 
                disclose, and safeguard your information when you visit our website trendverse-blog.web.app 
                (the "Site").
              </p>
              <p>
            ...
            <section>
              ...
              <div className="bg-white/5 rounded-xl p-4 mt-3">
                ...
                <p>Email: privacy@trendverse.com</p>
