        ...
        <div className="bg-gray-900/50 rounded-2xl border border-white/10 p-8 md:p-12">
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-gray-300">
            ...
            <section>
              ...
              <p>
                By accessing or using the TrendVerse website (trendverse-blog.web.app), you agree to be 
            ...
            <section>
              ...
              <p>
                Unless otherwise stated, TrendVerse and/or its licensors own the intellectual property 
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>Redistribute content from TrendVerse (unless specifically allowed)</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                In no event shall TrendVerse, its directors, employees, partners, agents, or affiliates 
            ...
            <section>
              ...
              <p>
                ...
                controlled by TrendVerse. We have no control over, and assume no responsibility for:
              </p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p>
                By subscribing to our newsletter, you agree to receive emails from TrendVerse. 
