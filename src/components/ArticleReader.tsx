        ...
        <div className={cn(
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <button className="px-4 py-2 bg-gradient-to-r from-violet-500 to-pink-500 text-white rounded-xl font-medium text-sm hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300">
                Follow
              </button>
            </div>
