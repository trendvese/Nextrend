            ...
            <div className="sticky top-28 space-y-6">
              ...
              <div className={cn(
                ...
                <div className="flex gap-3">
                  {[
                    { icon: '𝕏', color: 'from-slate-600 to-slate-800', label: 'Twitter/X' },
                    { icon: '📸', color: 'from-pink-500 to-purple-500', label: 'Instagram' },
                    { icon: '📺', color: 'from-red-500 to-red-600', label: 'YouTube' },
                    { icon: '💼', color: 'from-blue-500 to-blue-600', label: 'LinkedIn' },
                  ].map((social, index) => (
                    <a
                      key={index}
                      href="#"
        ...
        <footer className={cn(
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className={cn(
              ...
              Trend<span className="bg-gradient-to-r from-violet-500 to-pink-500 bg-clip-text text-transparent">Verse</span>
            </span>
          </div>
          <p className={cn(
            "text-sm",
            ...
            © 2024 TrendVerse. Exploring what's trending, one article at a time.
          </p>
